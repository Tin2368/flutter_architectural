...
//   Product(id: 'prod-01', category: 'xxx', imageUrl: 'https://images.unsplash.com/photo-1683660638539-50deb764cef2?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDh8fHxlbnwwfHx8fHw%3D', name: 'Bamboo', price: 399),
//   Product(id: 'prod-02', category: 'xxx', imageUrl: 'https://images.unsplash.com/photo-1713107102323-00cd32c4b7df?q=80&w=3092&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', name: 'Drum Bridge', price: 199),
//   Product(id: 'prod-03', category: 'xxx', imageUrl: 'https://images.unsplash.com/photo-1713107100898-793f1628c407?q=80&w=3074&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', name: 'Crytomeria Avenue', price: 299),
// ];
